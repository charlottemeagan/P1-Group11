...
chmod 400 $key_path/Team11Capstone.pem

#Download csv from vm instance                                                                          
echo "Downloading en_es_alphabet.csv ..."
scp -i $key_path/Team11Capstone.pem ec2-user@ec2-100-27-27-235.compute-1.amazonaws.com:/home/ec2-user/downloads/en_es_alphabet.csv $csv_path/en_es_alphabet.csv

#Open the vm?                                                                                           
echo "Opening the vm... "
echo "Type 'exit' to exit the vm..."
ssh -i $key_path/Team11Capstone.pem ec2-user@ec2-100-27-27-235.compute-1.amazonaws.com
